...
namespace lambdacommon::lstring
{
     ...
     */
    extern std::string LAMBDACOMMON_API from_wstring_to_utf8(const std::wstring& wstring);
     ...
     */
    extern std::wstring LAMBDACOMMON_API from_utf8_to_wstring(const std::string& string);
